      ...
      <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-blue-50 to-indigo-100 p-4">
        <div className="max-w-4xl w-full">
          ...
          <div className="flex justify-end mb-4">
            <button
              onClick={signOut}
              className="px-6 py-2.5 rounded-xl bg-white/80 border-2 border-gray-300 text-gray-700 font-semibold hover:bg-gray-50 hover:border-gray-400 transition-all shadow-md hover:shadow-lg flex items-center gap-2"
            >
